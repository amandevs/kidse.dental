...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Campaign /</span> Create Campaign </h4>
                ...
                <div class="card-body">
                    <form id="campaign">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control campaign_name"  name="campaign_name" id="basic-default-name"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="basic-default-phone" name="subject" class="form-control phone-mask subject"
                        ...
                        <input class="form-check-input" type="checkbox" value="1" name="customize" id="customize_switch"  />
                      </div>
                                    </div>
                            <div class="col-sm-4">
                                  <select class="form-select customize d-none" >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea id="email_content" class="form-control email_content" name="email_content"></textarea>
