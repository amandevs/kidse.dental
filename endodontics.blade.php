                ...
                <div class="col-md-12 col-lg-11 col-xl-10">
                    <div class="row">
                        ...
                        <a href="endodontics.php #products"
                            class="btn col-xl-2 col-lg-2 col-md-3 col-5 mt-3 ms-3 text-center fw-bold fs-5 border border-2 border-dark">Endodontics</a>
        ...
        <div class="col-xl-9 col-lg-10 col-11">
            <div class="row mt-3 align-items-center">
                ...
                <a href="" class="col-xl-2 col-md-3 col-sm-4 col-6 ms-xl-2 mt-4 ms-md-none ms-lg-block">
                    <div class="row">
                        <img src="{{ asset('images/store/box.png')}}" alt="" class="img-fluid col-12">
                    </div>
                    <div class="row">
                ...
                <a href="" class="col-xl-2 col-md-3 col-sm-4 col-6 ms-xl-2 mt-4 ms-md-none ms-lg-block">
                    ...
                    <div class="row">
                        <div class="fs-4 fw-bold text-dark text-center">e-IodoCal</div>
                    </div>
                </a>
