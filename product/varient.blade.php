        ...
        <div class="col-lg-6 my-5">
            <div class="row justify-content-center">
                <div class="col-11 col-sm-12">
                    ...
                    <p >{{$product_varient['buying_option']}}</p>

                    <p class="mb-">{!! nl2br(e($product_varient['discription'])) !!}</p>
                    ...
                    @auth
                        ...
                        <p class="mb-2">Price: INR {{$product_varient['price']}}</p>



                        <div class="py-3">
                            <form action="{{ route('order.address.varient', [$product['id'], $product_varient['variante_name']] ) }}" method="GET" enctype="multipart/form-data">
